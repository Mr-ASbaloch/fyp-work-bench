const formFields = [
    ...
    },
    {
      ...
      fields: [
        { name: 'supportingPersonName', label: 'Supporting Person Name', type: 'text' },
        { name: 'relationship', label: 'Relationship', type: 'text' },
        { name: 'supportingPersonOccupation', label: 'Supporting Person Occupation', type: 'text' },
        { name: 'monthlyFinancialSupport', label: 'Monthly Financial Support', type: 'text' },
      ],
    },
    {
      ...
      subFields: {
        accDetails: [
          ...
          { name: 'airConditioners', label: 'No. of Air Conditioners', type: 'text' },
    ...
    },
    {
      ...
      fields: [
        { name: 'tuitionCharges', label: 'Tuition Charges', type: 'text' },
        { name: 'gotScholarships', label: 'Have you got any scholarships?', type: 'checkbox' },
      ],
      subFields: {
        scholarships: [
