...
export const fetchAppliedScholarships = createAsyncThunk(
  'applications/fetchAppliedScholarships',
...
const applicationsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(fetchAppliedScholarships.pending, state => {
        state.status = 'loading';
      })
      .addCase(fetchAppliedScholarships.fulfilled, (state, action) => {
        state.status = 'succeeded';
        state.applications = action.payload;
      })
      .addCase(fetchAppliedScholarships.rejected, (state, action) => {
        state.status = 'failed';
        state.error = action.payload;
      });
  },
